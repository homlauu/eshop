...
public class Application {
	...
	public static void main(String[] args) {
		...
		/**
		 * bin/kafka-topics.sh --zookeeper 192.168.1.210:2181,192.168.1.211:2181,192.168.1.212:2181 --topic cache-message --replication-factor 1 --partitions 1 --create
		 * 
		 * bin/kafka-console-producer.sh --broker-list 192.168.1.210:9092,192.168.1.211:9092,192.168.1.212:9092 --topic cache-message
		 * --producer message:linux 
